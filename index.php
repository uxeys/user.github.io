...
<div class="logout-content">
    ...
    <!-- I dictvate this code because of appearing on my Home page-->
    <!--
...
-->
  ...
  <?php  if (isset($_SESSION['username'])) : ?>
    <!--I removed "Welcome" from 2st P -->
      <p style="color: white; font-size: 25px;"> <strong><?php echo $_SESSION['username']; ?></strong></p>
      <p> <a class="logout-button" href="index.php?logout='1'" style="color: black; text-decoration: none;">Logout</a> </p>
  <?php endif ?>
</div>
</header>
<!-- From here starts custom webpage-->
